        ...
        <div id ='about' className="flex justify-center p-4 mt-50">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-58 ">
                {abouts.map((item, index) => (
                    <div
                        key={index}
                        className="min-w-220 bg-white border-2 border-cyan-600 rounded-lg shadow-md dark:bg-gray-800 dark:border-amber-600 mx-auto"
                    >
                        <div className="flex flex-col items-center pb-8 pt-6 px-10">
                            ...
                            <div className="mt-6">
                                <Link href={`/edit/about/${item.id}`}>
                                    <button className=" h-12 w-40 flex justify-center cursor-pointer items-center px-6 py-4 text-lg font-medium text-white bg-cyan-600 rounded-lg hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800">
                                        Modifier
                                    </button>
                                </Link>
                            </div>
